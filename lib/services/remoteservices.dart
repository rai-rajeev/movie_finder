...
Future<TrendingMovies?> getTrending()async{
  ...
  var uri=Uri.parse('https://api.themoviedb.org/3/movie/popular?api_key=a2ad222507cfbfcfc69e2ffbdfaed7e0');
...
Future<TopRatedMovies?> getToprated()async{
  ...
  var uri=Uri.parse('https://api.themoviedb.org/3/movie/top_rated?api_key=a2ad222507cfbfcfc69e2ffbdfaed7e0');
  ...
  Future<NowPlayingMovies?> getNowPlaying()async{
    ...
    var uri=Uri.parse('https://api.themoviedb.org/3/movie/now_playing?api_key=a2ad222507cfbfcfc69e2ffbdfaed7e0');
  ...
  Future<Generes?> getGenre()async{
    ...
    var uri=Uri.parse('https://api.themoviedb.org/3/genre/movie/list?api_key=a2ad222507cfbfcfc69e2ffbdfaed7e0');
  ...
  Future<SearchMovies?> getSearchMovie(String query)async{
    ...
    var uri=Uri.parse('https://api.themoviedb.org/3/search/movie?api_key=a2ad222507cfbfcfc69e2ffbdfaed7e0&query=${query}');
