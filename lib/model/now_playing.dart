...
class Dates {
  ...
  Map<String, dynamic> toJson() => {
    "maximum":maximum!=null? "${maximum!.year.toString().padLeft(4, '0')}-${maximum!.month.toString().padLeft(2, '0')}-${maximum!.day.toString().padLeft(2, '0')}":"",
    "minimum":minimum!=null? "${minimum!.year.toString().padLeft(4, '0')}-${minimum!.month.toString().padLeft(2, '0')}-${minimum!.day.toString().padLeft(2, '0')}":"",
  };
}
...
class Result {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "id": id,
    "original_language": originalLanguageValues.reverse!=null? originalLanguageValues.reverse![originalLanguage]:"not known",
...
enum OriginalLanguage { English, Indonesian }
